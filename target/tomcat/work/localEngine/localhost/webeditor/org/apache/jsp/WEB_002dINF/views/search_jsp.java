...
public final class search_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<br />\r\n");
      out.write("\t<div style=\"width: 255px; float: left;\">\r\n");
      ...
      out.write("\t\t\t\t\twindow.location = 'search?' + buildTitleURI() + '&'\r\n");
      out.write("\t\t\t\t\t\t\t+ buildTagsURI();\r\n");
      out.write("\t\t\t\t} else if (titleText.length == 0 && tagsText.length != 2) {\r\n");
      out.write("\t\t\t\t\twindow.location = 'search?' + buildTagsURI();\r\n");
      out.write("\t\t\t\t} else if (titleText.length != 0 && tagsText.length == 2) {\r\n");
      out.write("\t\t\t\t\twindow.location = 'search?' + buildTitleURI();\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\twindow.location = 'search';\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/search.jsp(118,4) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/views/search.jsp(118,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
