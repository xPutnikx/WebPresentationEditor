...
public final class preview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \t</script>\r\n");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\" data-main=\"scripts/mainpreview\"\r\n");
      ...
      out.write("\t        $.ajax({\r\n");
      out.write("        \t    type: 'POST',\r\n");
      out.write("\t        \t    url: \"/webeditor/social/jsons\", \r\n");
      out.write("\t        \t    data: Ide,\r\n");
      out.write("\t        \t    dataType: \"json\",\r\n");
      out.write("\t        \t    success: function(data){\r\n");
      out.write("\t        \t    \tlocalStorage.setItem(\"open\",JSON.stringify(data));\r\n");
      out.write("\t        \t    \t$.doTimeout(1500, function(){\r\n");
      out.write("\t        \t    \t\t$(\"#present\").click();\r\n");
      out.write("\t        \t        \t});\r\n");
      out.write("\t        \t    \t\r\n");
      out.write("\t          \t\t}\r\n");
      out.write("\t            });\r\n");
