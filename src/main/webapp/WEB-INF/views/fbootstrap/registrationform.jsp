	...
	<div class="container" style="margin-top: 20px;">
		<form:form method="Post" action="registrationform"
			...
			<div class="well" style="color: black; width: 500px; height: 40px;">
				User Name:<FONT color="red"><form:errors path="name" /></FONT>
				<form:input path="name" />
			</div>
			<div class="well" style="color: black; width: 500px; height: 40px;">
				Password:<FONT color="red"><form:errors path="password" /></FONT>
				<form:password path="password" />
			</div>
			<div class="well" style="color: black; width: 500px; height: 40px;">
				Confirm Password:<FONT color="red"><form:errors
						path="confirmPassword" /></FONT>
				<form:password path="confirmPassword" />
			</div>
			<div class="well" style="color: black; width: 500px; height: 40px;">
				Email:<FONT color="red"><form:errors path="email" /></FONT>
