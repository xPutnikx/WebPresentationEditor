...
<div class="container" style="margin-top: 20px; width: 800px;">
	...
	<div id="content" style="padding: 30px">
			...
			<tbody id="tbody">
				<c:forEach items="${people}" var="v_person">
					...
					<tr id="tr${v_person.id}">
						<td><span class="label success"><a style="color: #FFF">${v_person.id}</a></span></td>
						<td>${v_person.name}</td>
						...
						<td><img
							src="resources/assets/png/glyphicons_207_remove_2.png"
							id="del${v_person.id}" onclick="del(${v_person.id})" /></td>
		...
		<p>
			<a class="btn" id="edit" data-controls-modal="modal-from-dom"
				data-backdrop="true" data-keyboard="true"><spring:message
					code="btn.addperson" /></a>
		</p>
	</div>
</div>
<div
	...
	<div id="dialog-form"
		...
		<form>
			<fieldset>
				<label for="name"><spring:message code="lbl.username" /></label> <input
					type="text" name="name" id="name"
					class="text ui-widget-content ui-corner-all"> <label
					for="email"><spring:message code="lbl.email" /></label> <input
					type="text" name="email" id="email" value=""
					class="text ui-widget-content ui-corner-all"> <label
					for="password"><spring:message code="lbl.password" /></label> <input
	...
	<div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
		<div class="ui-dialog-buttonset">
			<button type="button"
				...
				<span class="btn primary"><spring:message
						code="btn.createaccount" /></span>
			</button>
			<button type="button"
