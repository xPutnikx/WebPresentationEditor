...
<body>
	...
	<div class="container" style="width: 800px">
		...
		style="width: 230px; margin-left: auto; margin-right: auto;">		
            <b><spring:message code="lbl.username"/>:</b><font color="red"><form:errors path="name"/></font>    
			<form:input path="name" /><br /><br />
            <b><spring:message code="lbl.password"/>:</b><font color="red"><form:errors	path="password" /></font>   
			<form:password path="password" /><br /><br />             
            <b><spring:message code="lbl.confirmpassword"/>:</b><font color="red"><form:errors	path="confirmPassword" /></font>   
			<form:password path="confirmPassword" /><br /><br />			             
            <b><spring:message code="lbl.email"/>:</b><font color="red"><form:errors path="email" /></font>   
