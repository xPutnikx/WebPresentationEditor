...
<body>
		...
		<div class="fill">
			<div class="container" style="width: 760px">
				...
				<ul class="nav">
					...
					<li  class="active"><a href="presentations"><spring:message code="btn.presentations"/></a></li>
	...
	<div class="container" style="width: 800px">
		<div style="width: 255px; float: left; color: black;">
			<form class="well">
				<label style="width:0"><spring:message code="lbl.title"/>:</label><br /><br />
				<textarea id="title-text-area" rows="1"></textarea>
				<br /> <label style="width:0"><spring:message code="lbl.tags"/>:</label><br /><br />
				<textarea id="tags-text-area" rows="3"></textarea>
				<br />
				<button id="search-btn" type="submit" class="btn primary"><spring:message code="btn.search"/></button>
			</form>
		</div>
			...
			<table class="table table-striped"
				...
				<thead>
					<tr>
						...
						<th style="width: 300px"><spring:message code="lbl.description"/></th>						
					</tr>
				</thead>
				<tbody>
