				...
				"ItemGrabber" : Handlebars
						.template(function(Handlebars, depth0, helpers,
							...
							if (typeof stack1 === functionType) {
								...
								stack1 = helperMissing.call(depth0, "title", {
									hash : {}
								});
							}
							...
							if (typeof stack1 === functionType) {
								...
								stack1 = helperMissing.call(depth0, "tag", {
									hash : {}
								});
							}
							buffer += escapeExpression(stack1)
				...
				"RawTextImporter" : Handlebars
						...
						"SaveAsDialog": Handlebars.template(
						         function (Handlebars, depth0, helpers, partials, data) {
						             ...
						             buffer = "<script type=\"text/javascript\">function submitForm() {$.ajax({type: 'POST',url: '/webeditor/social/json',data: { title: $(\"#Title\").val(), description: $(\"#Description\").val(), tags: $(\"#Tags\").textext()[0].hiddenInput().val(), json:localStorage.getItem(\"jsonString\")},traditional: true});}</script><body><form id=\"SaveAsForm\" class=\"openDialog modal in\" style=\"display: block; \"> <div class=\"modal-header\"><button class=\"close\" data-dismiss=\"modal\">x</button> <h3>Save as...</h3> </div><div class=\"modal-body\"><h4><label>Title:</label></h4> <input type=\"text\" id=\"Title\" /><br /> <h4><label>Description:</label></h4> <input type=\"text\" id=\"Description\" /><br /><h4><label>Tags:</label><label><i>Press \"Enter\" to add a tag.</i></label></h4> <input type=\"text\" id=\"Tags\" /><br /><input type=\"hidden\" id=\"Json\" value=\"\"/> </div><div class=\"modal-footer\"><a href=\"#\" class=\"btn btn-inverse ok\" onclick=\"submitForm()\">OK</a><a href=\"#\" class=\"btn\" data-dismiss=\"modal\">Cancel</a></div> </form></body><script type=\"text/javascript\" src=\"resources/assets/js/jquery-textext-1.3.0.js\"></script><script type=\"text/javascript\">$(\"#Title\").textext({}); $(\"#Description\").textext({}); $(\"#Tags\").textext({ plugins : \"tags\" });</script>";
						             return buffer;
						         })
			}
		});