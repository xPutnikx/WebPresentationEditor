				...
				.template(function(Handlebars, depth0, helpers,
					...
					function program1(depth0, data) {
						...
						if (typeof stack1 === functionType) {
							...
							stack1 = helperMissing.call(depth0, ".", {
								hash : {}
							});
						}
					...
					buffer += "<div class=\"modal-header\">	<button class=\"close\" data-dismiss=\"modal\">×</button>	<h3>Open</h3></div><div class=\"modal-body\">	<ul class=\"nav nav-list\">		";
