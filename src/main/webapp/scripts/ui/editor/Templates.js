define(
		[ "vendor/amd/Handlebars" ],
		function(Handlebars) {
			return {

				"Component" : Handlebars
				.template(function(Handlebars, depth0, helpers,
						partials, data) {
					...
					if (typeof stack1 === functionType) {
						...
						stack1 = helperMissing.call(depth0, "x", {
							hash : {}
						});
					}
					...
					if (typeof stack1 === functionType) {
						...
						stack1 = helperMissing.call(depth0, "y", {
							hash : {}
						});
					}
					buffer += escapeExpression(stack1)
				...
				"TransitionSlideSnapshot" : Handlebars
				.template(function(Handlebars, depth0, helpers,
						partials, data) {
					helpers = helpers || Handlebars.helpers;
					var buffer = "", stack1, foundHelper, self = this, functionType = "function", helperMissing = helpers.helperMissing, undef = void 0, escapeExpression = this.escapeExpression;
					...
					if (typeof stack1 === functionType) {
						...
						stack1 = helperMissing.call(depth0, "rotateY",
								{
							hash : {}
								});
					}
					...
					if (typeof stack1 === functionType) {
						...
						stack1 = helperMissing.call(depth0, "rotateX",
								{
							hash : {}
								});
					}
					...
					if (typeof stack1 === functionType) {
						...
						stack1 = helperMissing.call(depth0, "rotateZ",
								{
							hash : {}
								});
					}
					...
					if (typeof stack1 === functionType) {
						...
						stack1 = helperMissing.call(depth0, "z", {
							hash : {}
						});
					}
					buffer += escapeExpression(stack1)
					...
					if (typeof stack1 === functionType) {
						...
						stack1 = helperMissing.call(depth0, "impScale",
								{
							hash : {}
								});
					}
