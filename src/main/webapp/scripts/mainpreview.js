...
if (window.location.href.indexOf("preview=true") !== -1) {
	/*alert("Preview");
	requirejs(["model/editor/button_bar/ButtonBarModel", "model/presentation/components/ComponentFactory"], function(ButtonBarModel, ComponentFactory) {
		alert("rjs");
	});	*/
} else {
  continuation = function() {
	// trigger preview 
	/*requirejs(["ui/editor/Editor", "model/presentation/Deck", "storage/FileStorage"], function(Editor, Deck, FileStorage) {
    ...
    return requirejs(["ui/editor/Editor", "model/presentation/Deck", "storage/FileStorage"], function(Editor, Deck, FileStorage) {
      ...
      //$("body").append(editor.render());
	  editor.render();
      lastPres = localStorage.getItem("open");
      if (lastPres != null) {
        pres = FileStorage.open(lastPres);
        if (pres != null) {
          deck["import"](pres);
